...
<body>
	...
	<body>
		...
		<!-- SECTION -->
		<jsp:include page="./include/products-1.jsp"/>
		<!-- /SECTION -->
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="<c:url value="/product-detail"/>">product name goes here</a></h3>
		...
		<!-- NEWSLETTER -->
		<jsp:include page="./include/newletter.jsp"/>
		<!-- /NEWSLETTER -->
